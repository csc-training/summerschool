...
int main(int argc, char **argv) {
    ...
    hid_t dataspace = H5Screate_simple(1, (const hsize_t[]){(hsize_t)numprocs}, NULL);
    ...
    H5Sselect_hyperslab(dataspace, H5S_SELECT_SET, (const hsize_t[]){(hsize_t)myproc}, NULL, count, NULL);
