...
- (image: Matrix split horizontally across GPUs)
- How it affects the Flops
...
- (image: Sequential model chunks on different GPUs)
...
- (image: Mini cube diagram combining DP, TP, PP)
