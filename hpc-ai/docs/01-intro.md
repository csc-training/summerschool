...
- continue the chain rule from the previous result:
     ...
     - $\frac{\partial \Sigma_{j2}}{\partial w_{ij1}}= w_{ij2}\frac{\varphi_{i1}}{\partial w_{ij1}}$ or $\frac{\partial \Sigma_{j2}}{\partial w_{ij1}}= w_{ij2}\frac{\varphi_{i1}}{\partial w_{ij1}}$????
...
- final result:
     ...
     - $\frac{\partial w_{ij1}}{\partial t}=[\Sigma_{k}( T_k-\varphi_{ok})]\frac{\partial f_2}{\partial \Sigma_{j2}}\cdot x_i$; $i\neq 0$
