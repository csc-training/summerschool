...
- **loss function** measures how good/bad a model’s predictions are compared to the actual results: $\mathrm{E}_\mathrm{t}=\frac{1}{2}\sum_j\left[\mathrm{T}_{\mathrm{j}}-\mathrm{\varphi}_{\mathrm{oj}} \right]^2$
