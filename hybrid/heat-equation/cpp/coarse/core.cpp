...
void evolve(Field& curr, const Field& prev, const double a, const double dt)
{
  ...
  //#pragma omp for collapse(2)     // Collapse nested loops into one loop for possible improved parallelisation. 
  ...
  #pragma omp for                 // Only the outer loop is parallelised. If the outer loop is smaller than the 
