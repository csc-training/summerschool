                ...
                parallel_data *parallel)
{
	...
	/* TODO: Add here the needed initialization routines for RMA
...
{
    /* TODO: Implement the boundary value exchange using one-sided
	         communication */
}
