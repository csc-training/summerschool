...
void write_restart(field *temperature, parallel_data *parallel, int iter)
{
    ...
    //is the temperature->data array including the ghost layers. Use a
    //collective writes.
...
void read_restart(field * temperature, parallel_data * parallel, int *iter)
{
    ...
    //TODO All ranks reads the header using collective IO 
    ...
    //TODO All processes reads their temperature data from the file, this
    //is the temperature->data array including the ghost layers. Use a
    //collective read.
